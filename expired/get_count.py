...
querystring = {"f":"json","returnIdsOnly":"true","returnCountOnly":"true","orderByFields":"GazetteDate_Date DESC,Status ASC,District_EN ASC","spatialRel":"esriSpatialRelIntersects","where":"((Status_Cal LIKE '%History%'))"}
