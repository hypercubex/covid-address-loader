...
querystring = {"f":"json","resultOffset":"0","resultRecordCount":"8000","where":"((Status_Cal LIKE '%7%'))","orderByFields":"GazetteDate_Date DESC,Status ASC,District_EN ASC","outFields":"*","spatialRel":"esriSpatialRelIntersects"}
